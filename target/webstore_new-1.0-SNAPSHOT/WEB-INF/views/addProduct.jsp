...
<section>
    <div class="jumbotron">
        <div class="container">
            <h1><spring:message code="addProduct.form.product.label"/></h1>
...
<section class="container">
    <form:form  method="POST" modelAttribute="newProduct" class="form-horizontal" enctype="multipart/form-data">
        ...
        <fieldset>
             <legend><spring:message code="addProduct.form.addNew.label"/></legend>
...
<br>
            ...
            <br>
             ...
             <br>
                    ...
                    <div class="form-group">
                     <label class="control-label col-lg-2" for="discontinued"><spring:message code="addProduct.form.discountinued.label"/></label>
                    <div class="col-lg-10">
               ...
               -->
                ...
                <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                        ...
                        <a href=" <spring:url value="/webstore/market/products" /> " class="btn btn-primary">
