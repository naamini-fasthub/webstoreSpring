...
public class Product {
    ...
    @NotEmpty(message= "Min.Product.category.validation")
...
/*@JsonIgnore
    ...
    * @XmlTransient
    public MultipartFile getProductPdfFile() {
        return productPdfFile;
    }

    public void setProductPdfFile(MultipartFile productPdfFile) {
        this.productPdfFile = productPdfFile;
    }
